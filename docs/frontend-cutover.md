...
16. compare reviewed resume skills with requirements observed in chosen roles;
17. open the verified job page for user review.
...
| Observed-role skill intelligence | Complete for verified accounts | Not available | Next.js canonical |
